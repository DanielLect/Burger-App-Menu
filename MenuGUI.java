...
public class MenuGUI {
   ...
   // Menu version for the case when we have promotion
   MenuGUI(String myFranchise, String promotion, String name1, String price1, String top1, String disprice1, String name2, String price2, String top2, String disprice2, String name3, String price3, String top3, String disprice3, double exchangeRate) {
        ...
        b1=new JLabel(name1+"/ "+disprice1+" (regular) "+price1);
        b1.setFont(new Font("Serif", Font.PLAIN, 30));
        b1.setBounds(200,105,W,H/6);

        b2=new JLabel(name2+"/ "+disprice2+" (regular) "+price2);
        b2.setFont(new Font("Serif", Font.PLAIN, 30));
        b2.setBounds(200,240,W,H/6);

        b3=new JLabel(name3+"/ "+disprice3+" (regular) "+price3);
        ...
        rate = new JLabel("Exchange Rate: 1:"+Double.toString(exchangeRate) + " (As of "+d+")");
        rate.setBounds(W-600, H-100, 600,40);
        rate.setForeground(Color.BLACK);
        rate.setFont(new Font("Serif", Font.ITALIC, 16));
    ...
    MenuGUI(String myFranchise,String promotion,String name1,String price1,String top1, String name2,String price2,String top2,String name3,String price3,String top3, double exchangeRate){
		 SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
		    Date date = new Date();  
		    String d= formatter.format(date);
